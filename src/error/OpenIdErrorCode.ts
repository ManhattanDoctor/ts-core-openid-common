...
export enum OpenIdErrorCode {
    ...
    TOKEN_UNDEFINED = 'OPEN_TOKEN_UNDEFINED',
    ...
    TOKEN_SIGNATURE_ALGORITHM_UNKNOWN = 'TOKEN_SIGNATURE_ALGORITHM_UNKNOWN',

    OPTIONS_PUBLIC_KEY_UNDEFINED = 'OPEN_ID_OPTIONS_PUBLIC_KEY_UNDEFINED',

    NOT_AUTHORIZED = 'OPEN_ID_NOT_AUTHORIZED',
    SESSION_NOT_ACTIVE = 'OPEN_ID_SESSION_NOT_ACTIVE',
}
